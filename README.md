...
**Where?** *[GitHub](https://github.com/chawins/llm-sp) ⭐ 584 | 🐛 3 | 🌐 Python | 📅 2025-06-08 and [Notion](https://chawins.notion.site/llm-sp). Notion is more up-to-date; I periodically transfer the updates to GitHub.*

**Who?** *[Me](https://chawins.github.io/) and you (see [Contribution](https://github.com/chawins/llm-sp?tab=readme-ov-file#contribution) ⭐ 584 | 🐛 3 | 🌐 Python | 📅 2025-06-08 below).*
...
* <https://github.com/Hannibal046/Awesome-LLM/> ⭐ 27,358 | 🐛 452 | 📅 2025-07-31: Huge compilation of LLM papers and software.
* <https://github.com/corca-ai/awesome-llm-security> ⭐ 1,693 | 🐛 217 | 📅 2025-08-20: A curation of awesome tools, documents and projects about LLM Security.
...
* <https://github.com/NVIDIA/NeMo> ⭐ 18,429 | 🐛 303 | 🌐 Python | 📅 2026-09-12: NeMo: a toolkit for conversational AI.
* <https://github.com/leondz/garak> ⭐ 9,209 | 🐛 425 | 🌐 Python | 📅 2026-09-09: LLM vulnerability scanner.
...
The paper selection is biased towards my research interest. So any help to make this list more comprehensive (adding papers, improving descriptions, etc.) is certainly appreciated. Please feel free to open an issue or a PR on the [GitHub repo](https://github.com/chawins/llm-sp) ⭐ 584 | 🐛 3 | 🌐 Python | 📅 2025-06-08.
